//we have to create a bank appication 
//with following functionalities createAccount() deposite() withdraw() balanceenq()
class Bank{
...
var obj=new Bank()
obj.createaccount("ajay",6727536,5000)
obj.withdraw(5000)
obj.deposite(4000)
obj.balanceenq()
var obj2=new Bank()
obj2.createaccount("vijay",644566,6777)
obj2.deposite(12000)
obj2.withdraw(1000)
